            ...
            success: function (rspdata) {
              ...
              $.getJSON('https://coincap.io/exchange_rates').done(function(responseRates){
                  ...
                  if($cur != 'BTC'){
                    ...
                    if($filter == 'ETC' || $filter == 'EDO' || $filter == 'SAN'  || $filter == 'BCH' || $filter == 'IOT' || $filter == 'DASH' || $filter == 'LTC' || $filter == 'ETP' || $filter == 'NEO' || $filter == 'ZEC' || $filter == 'EOS'  || $filter == 'OMG'  || $filter == 'XMR'){
                  ...
                  if($filter == 'XRP' || $filter == 'ETC' || $filter == 'LTC' || $filter == 'EDO' || $filter == 'SAN' || $filter == 'BCH' || $filter == 'IOT' || $filter == 'DASH' || $filter == 'LTC' || $filter == 'ETP' || $filter == 'NEO' || $filter == 'ZEC' || $filter == 'EOS' || $filter == 'OMG'  || $filter == 'XMR'){
      ...
      // this method is called when chart is first inited as we listen for "dataUpdated" event
                  ...
                  setInterval(function(){
                    $.getJSON( "coin_live_price/"+$filter+".json", function( json ) {
                      ...
                      //    console.log($dPrice);
                          if($filter == 'XRP' || $filter == 'ETC' || $filter == 'ETH' || $filter == 'EDO' || $filter == 'SAN'  || $filter == 'BCH' || $filter == 'IOT' || $filter == 'DASH' || $filter == 'LTC' || $filter == 'ETP' || $filter == 'NEO' || $filter == 'ZEC' || $filter == 'EOS'  || $filter == 'OMG'  || $filter == 'XMR'){
                      ...
                      //    console.log('Last:'+$lastDate);
                              ...
                              if($currentMatchDate == $lastDate){
                                  ...
                                  if($cur == 'BTC'){
                                      ...
                                      if($currencyPair == 'BTC'){
                                          ...
                                          if($filter == 'ETH' || $filter == 'EDO' || $filter == 'ETC' || $filter == 'SAN' || $filter == 'BCH' || $filter == 'IOT' || $filter == 'DASH' || $filter == 'LTC' || $filter == 'ETP' || $filter == 'NEO' || $filter == 'ZEC' || $filter == 'EOS'  || $filter == 'OMG'  || $filter == 'XMR'){
                            ...
                            if($filter == 'XRP' || $filter == 'ETC' || $filter == 'ETH' || $filter == 'LTC' || $filter == 'EDO' || $filter == 'SAN' || $filter == 'BCH' || $filter == 'IOT' || $filter == 'DASH' || $filter == 'LTC' || $filter == 'ETP' || $filter == 'NEO' || $filter == 'ZEC' || $filter == 'EOS' || $filter == 'OMG' || $filter == 'XMR'){
    ...
    $(document).ready(function(){
      ...
      $('.date-to').datepicker({
        ...
        $('.select_coin').click(function(){
            ...
            location.href = 'go_mobile.php?coin='+$(this).attr('data-coin')+'&currency='+$(this).attr('data-pair')+$urlC+$urlTemplate;
        ...
        $.ajax({
            ...
            success: function (rspdata) {
              ...
              //      console.log($tickValue);
                  ...
                  $chart = AmCharts.makeChart( "chartdiv1", config );
